...
% Define orientation vector of target pointing to wrist th5
ori06 = [T06(1,3);T06(2,3);T06(3,3)];

% Find distance from target to th4/th5 (4 and 5 are coincident)
dist46 = d(6)*ori06;

% Find distance from base to th4
dist04 = dist06-dist46;

%%%% Solution 1 %%%%
% Find both angles of base rotation (th1)
...
% Replace values below with DH parameters
l1 = sqrt(35^2+515^2);
l2 = 560;
...
%%%% Solution 2 %%%%
% Find both angles of elbow rotation (th3)
...
%%%% Solution 3 %%%%
% Find both angles of shoulder rotation (th2)
...
%%%% Solution 4 %%%%
% Find angle of wrist rotation (th5)
IK_th5 = pi-acos(dot(ori04,ori06));

%joint 4 and 6

% We need to include the orientation of the tool otherwise we will 
% have too many solutions.

% Rotation matrix from 4 to 6
R46 = A4(1:3,1:3)*A5(1:3,1:3)*A6(1:3,1:3);
% R46 = rotz(th4)*roty(pi+th5)*rotz(th6);
...
% Angles = eval(IK_th6)
Angles = eval([IK_th1;IK_th2;IK_th3;IK_th4 IK_th4;IK_th5 IK_th5;IK_th6 IK_th6])

% Theta = eval([th1;th2;th3;th4;th5;th6])
